...
class _ArtistLoginScreenState extends State<ArtistLoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // Check if user exists in artist collection
      ...
      if (!artistDoc.exists) {
        // User is not an artist, sign them out
        await FirebaseAuth.instance.signOut();
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text(
                  'This account is not registered as an artist. Please sign up as an artist.'),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Sign in to continue as an artist',
                    style: TextStyle(
                      color: Colors.grey,
                      fontSize: 16,
                    ),
